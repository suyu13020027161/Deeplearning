...
def prepare_images_and_labels(image_path, csv_path):
    save_directory = r'/home/ysu/Deeplearning/linedetect/labimg'
    images = []
    labels = []
    x1_list = []
    y1_list = []
    ...
    for image_file in image_files:
        ...
        save_path = os.path.join(save_directory, f"{base_name}.jpg")
...
def build_model():
    model = Sequential([
        Rescaling(1./255, input_shape=(800, 600, 1)),  # 添加归一化层，将输入数据范围从[0, 255]缩放到[0, 1]
        #第一个卷积层
